...
export class ReporterOptions {
   ...
   * @returns void
   */
  public async getVersionId(): Promise<void> {
   ...
   * @returns void
   */
  public async getSprintId(): Promise<void> {
   ...
   */
  public async deleteOldCycles(): Promise<void> {
   ...
   */
  public async createCycle(): Promise<void> {
   ...
   */
  public async getIssueId(testId: any): Promise<any> {
    if (isNaN(testId)) {
   ...
   */
  public async addingExecutionToCycle(testId: string): Promise<void> {
   ...
   */
  public async ExecuteSpecs(specsResult: SpecResult[]) {
   ...
   */
  public async executeTest(result: jasmine.SuiteResult, specsResult: SpecResult[]) {
  ...
  public async attachedFiles(o: AttachedFilesConfig) {
    if (
      !o ||
      !o.path ||
      !o.state ||
   ...
   * @returns specInfo
   */
  public specInfo(result: jasmine.SpecResult): SpecResult {
   ...
   */
  public TestExecutionID(testDescription: string) {
   ...
   */
  public testResultLogic<k extends keyof Status>(specsResult: SpecResult[]): k {
    let store: any[] = [];
